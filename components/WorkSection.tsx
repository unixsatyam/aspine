  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="mb-20">
          <div className="text-sm font-bold uppercase tracking-widest text-gray-500 mb-4">Portfolio</div>
          <h2 className="text-5xl md:text-6xl font-black text-black mb-6">Our Work</h2>
          <p className="text-xl text-gray-600 max-w-2xl">
            Explore our projects by category. Click on any service to see detailed case studies.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service) => (
            <div
              key={service.id}
              className="bg-white text-black p-10 border-4 border-black hover:bg-black hover:text-white transition-all duration-500 group relative"
            >
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="pt-6 border-t-2 border-black group-hover:border-white">
                  <Link
                    href={`/services/${service.id}`}
                    className="inline-block px-6 py-3 bg-black text-white group-hover:bg-white group-hover:text-black font-bold uppercase text-sm transition-colors"
                  >
                    View Projects →
                  </Link>
                </div>
